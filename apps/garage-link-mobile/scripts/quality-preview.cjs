...
const job={id:'fixture-job',job_no:'M-DEMO-001',job_type:'定期点検',status:'working',scheduled_in_at:'2026-09-10T00:00:00Z',scheduled_delivery_at:'2026-09-10T07:00:00Z',assigned_user_name:'デモ担当',estimated_total_amount:55000,customerName:'デモ顧客 株式会社',vehicleLabel:'DEMO-001 / デモ自動車 / サンプルワゴン'};
