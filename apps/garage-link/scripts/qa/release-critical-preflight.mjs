...
async function main(){
  ...
  const mailSlurpApiKey=required('GARAGE_STAGING_MAILSLURP_API_KEY');
  ...
  const mailSlurp=await verifyMailSlurpApiKey(mailSlurpApiKey);
