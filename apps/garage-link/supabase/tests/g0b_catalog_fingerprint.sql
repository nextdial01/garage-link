...
where n.nspname in ('public','qa_internal','supabase_migrations') and c.relkind in ('r','p','v','m','S');
...
where n.nspname in ('public','qa_internal') and p.prokind='f';
...
where n.nspname in ('public','qa_internal','supabase_migrations');
...
where n.nspname in ('public','qa_internal','supabase_migrations') or n.nspname is null;
