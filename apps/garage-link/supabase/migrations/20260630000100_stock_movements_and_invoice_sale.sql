-- Deployable migration promotion of supabase/schema/038_stock_movements_and_invoice_sale.sql.
-- See 20260630000000_delivery_candidate_event_types.sql for why this promotion exists.
-- No later migration depends on 038 specifically, but it must apply in this position so the
-- migrations directory replays 037-041 in the same order they were designed and reviewed in.
--
-- The SQL body below is byte-identical to supabase/schema/038_stock_movements_and_invoice_sale.sql
