-- Deployable migration promotion of supabase/schema/044_vehicle_market_and_listing_status.sql.
-- The SQL body is intentionally kept byte-identical to the canonical schema file.
