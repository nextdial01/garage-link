  ...
  return (
    <>
      ...
      <Modal
        ...
        footer={<button type="button" onClick={() => setOpen(false)} className="w-full rounded-xl bg-blue-600 px-4 py-3 text-sm font-bold text-white hover:bg-blue-700">閉じる</button>}
      >
