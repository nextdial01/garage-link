    ...
    sections: [
      {
        ...
        items: [
          ...
          { title: "Starter｜月額6,800円", body: "在庫50台、スタッフ1人、1店舗。見積・請求は月20件まで利用できます。" },
          { title: "Standard｜月額14,800円", body: "在庫200台、スタッフ3人、1店舗。見積・請求は上限なしで、L-LINK連携に対応します。" },
          { title: "Pro｜月額29,800円", body: "在庫500台、スタッフ10人、3店舗。見積・請求は上限なしで、L-LINK連携に対応します。" },
        ],
      },
      {
        ...
        items: [
          { title: "追加スタッフ｜月額1,000円／人", body: "追加できる対象プランで、店舗の運用人数に合わせて増やせます。" },
          { title: "追加店舗｜月額5,000円／店舗", body: "Standard・Proで、契約に含まれる店舗数を超える場合に追加できます。" },
          { title: "個別サポート｜60分10,000円", body: "画面を共有した個別支援の料金です。通常のチャットサポートは各プランに含まれます。" },
        ],
      },
    ],
  },
