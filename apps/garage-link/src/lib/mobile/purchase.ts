export const PURCHASE_FIELDS = 'id, store_id, vin, management_no, maker, model_name, status, purchase_supplier_name, purchase_supplier_type, purchase_date, purchase_price, direct_cost_special, direct_cost_accessories, direct_cost_agency, direct_cost_legal, direct_cost_other, direct_cost_repair, listing_price, sale_price, sold_date, market_value, created_at, updated_at';
...
export const money = (value: unknown) => typeof value === 'number' && Number.isSafeInteger(value) && value >= 0 && value <= 100_000_000 ? value : null;
